...
class VideoRecorder(object):
    ...
    #     if self.frames:
    #         skvideo.io.vwrite("{}/{}_episode_{}.mp4".format(self.directory, self.env_id, self.episode_id), np.array(self.frames))
    #     else:
    #         print('No video is recorded for episode:{}'.format(self.episode_id))
